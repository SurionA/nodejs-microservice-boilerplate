![NodeJS RESTful API Microservice Logo](https://github.com/SurionA/nodejs-microservice-starter/blob/master/logo.jpg)

# NodeJS RESTful API Microservice Starter v0.0.1
